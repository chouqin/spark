...
package org.apache.spark.mllib2.clustering
...
import org.apache.spark.mllib2.util.{LocalClusterSparkContext, LocalSparkContext}
import org.apache.spark.mllib2.util.TestingUtils._

class KMeansSuite extends FunSuite with LocalSparkContext {

  import org.apache.spark.mllib2.clustering.KMeans.{K_MEANS_PARALLEL, RANDOM}
