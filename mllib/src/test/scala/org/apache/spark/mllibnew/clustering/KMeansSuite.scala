...
package org.apache.spark.mllibnew.clustering
...
import org.apache.spark.mllibnew.util.{LocalClusterSparkContext, LocalSparkContext}
import org.apache.spark.mllibnew.util.TestingUtils._

class KMeansSuite extends FunSuite with LocalSparkContext {

  import org.apache.spark.mllibnew.clustering.KMeans.{K_MEANS_PARALLEL, RANDOM}
