...
import org.apache.spark.mllibnew.linalg.{DenseVector, SparseVector, Vector}
 ...
 */
class NaiveBayesModel private[mllibnew] (
...
class NaiveBayes private (private var lambda: Double) extends Serializable with Logging {
   ...
   *
   * @param data RDD of [[org.apache.spark.mllibnew.regression.LabeledPoint]].
   */
