...
package org.apache.spark.mllibnew.util
...
import org.apache.spark.mllibnew.linalg.{Vector, Vectors}
...
object MLUtils {
   ...
   * This method parses each line into a [[org.apache.spark.mllibnew.regression.LabeledPoint]],
   ...
   *
   * @see [[org.apache.spark.mllibnew.util.MLUtils#loadLibSVMFile]]
   */
   ...
   *            [[org.apache.spark.mllibnew.util.MLUtils#loadLabeledPoints]] for loading.
   */
   ...
   */
  private[mllibnew] def fastSquaredDistance(
      v1: BV[Double],
      norm1: Double,
      v2: BV[Double],
      norm2: Double,
