...
object KMeans {
   ...
   */
  private[mllibnew] def findClosest(
   ...
   */
  private[mllibnew] def pointCost(
      centers: TraversableOnce[BreezeVectorWithNorm],
   ...
   * [[org.apache.spark.mllibnew.util.MLUtils#fastSquaredDistance]].
   */
 ...
 *
 * @see [[org.apache.spark.mllibnew.clustering.KMeans#fastSquaredDistance]]
 */
private[clustering]
