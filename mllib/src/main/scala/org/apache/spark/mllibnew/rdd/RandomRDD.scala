...
package org.apache.spark.mllibnew.rdd

import org.apache.spark.{Partition, SparkContext, TaskContext}
import org.apache.spark.mllibnew.linalg.{DenseVector, Vector}
import org.apache.spark.mllibnew.random.RandomDataGenerator
...
private[mllibnew] class RandomRDDPartition[T](override val index: Int,
    val size: Int,
...
private[mllibnew] class RandomRDD[T: ClassTag](@transient sc: SparkContext,
    size: Long,
    numPartitions: Int,
...
private[mllibnew] class RandomVectorRDD(@transient sc: SparkContext,
    size: Long,
    vectorSize: Int,
    numPartitions: Int,
...
private[mllibnew] object RandomRDD {
