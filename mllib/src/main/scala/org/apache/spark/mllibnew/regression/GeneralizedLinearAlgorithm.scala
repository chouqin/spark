...
package org.apache.spark.mllibnew.regression
...
import org.apache.spark.mllibnew.linalg.{Vectors, Vector}
import org.apache.spark.mllibnew.util.MLUtils._
...
abstract class GeneralizedLinearAlgorithm[M <: GeneralizedLinearModel]
   ...
   */
  private[mllibnew] def setFeatureScaling(useFeatureScaling: Boolean): this.type = {
