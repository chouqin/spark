...
package org.apache.spark.mllibnew.tree
...
import org.apache.spark.mllibnew.rdd.RDDFunctions._
import org.apache.spark.mllibnew.regression.LabeledPoint
import org.apache.spark.mllibnew.tree.configuration.Strategy
import org.apache.spark.mllibnew.tree.configuration.Algo._
import org.apache.spark.mllibnew.tree.configuration.FeatureType._
import org.apache.spark.mllibnew.tree.configuration.QuantileStrategy._
import org.apache.spark.mllibnew.tree.impl._
import org.apache.spark.mllibnew.tree.impurity.{Impurities, Impurity}
import org.apache.spark.mllibnew.tree.impurity._
import org.apache.spark.mllibnew.tree.model._
...
class DecisionTree (private val strategy: Strategy) extends Serializable with Logging {
   ...
   * @param input Training data: RDD of [[org.apache.spark.mllibnew.regression.LabeledPoint]]
...
object DecisionTree extends Serializable with Logging {
   ...
   *
   * Note: Using [[org.apache.spark.mllibnew.tree.DecisionTree$#trainClassifier]]
   *       and [[org.apache.spark.mllibnew.tree.DecisionTree$#trainRegressor]]
   *       is recommended to clearly separate classification and regression.
   *
   * @param input Training dataset: RDD of [[org.apache.spark.mllibnew.regression.LabeledPoint]].
  ...
  */
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllibnew.tree.DecisionTree$#trainClassifier]]
   */
  def trainClassifier(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllibnew.tree.DecisionTree$#trainRegressor]]
   */
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
      categoricalFeaturesInfo: java.util.Map[java.lang.Integer, java.lang.Integer],
   ...
   *
   * @param input Training data: RDD of [[org.apache.spark.mllibnew.tree.impl.TreePoint]]
   ...
   *         Splits is an Array of [[org.apache.spark.mllibnew.tree.model.Split]]
   *          of size (numFeatures, numSplits).
   *         Bins is an Array of [[org.apache.spark.mllibnew.tree.model.Bin]]
