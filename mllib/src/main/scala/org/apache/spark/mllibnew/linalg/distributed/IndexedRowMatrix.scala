...
package org.apache.spark.mllibnew.linalg.distributed
...
import org.apache.spark.mllibnew.linalg.SingularValueDecomposition

/**
 * :: Experimental ::
 * Represents a row of [[org.apache.spark.mllibnew.linalg.distributed.IndexedRowMatrix]].
 */
@Experimental
...
/**
 * :: Experimental ::
 * Represents a row-oriented [[org.apache.spark.mllibnew.linalg.distributed.DistributedMatrix]] with
 * indexed rows.
 *
...
class IndexedRowMatrix(
   ...
   * [[org.apache.spark.mllibnew.linalg.distributed.RowMatrix]].
   */
   ...
   *
   * U is an [[org.apache.spark.mllibnew.linalg.distributed.IndexedRowMatrix]] of size m x k that
   * satisfies U'U = eye(k),
  ...
  private[mllibnew] override def toBreeze(): BDM[Double] = {
    val m = numRows().toInt
    val n = numCols().toInt
