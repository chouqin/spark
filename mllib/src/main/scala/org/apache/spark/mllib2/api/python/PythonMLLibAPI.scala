...
package org.apache.spark.mllib2.api.python
...
import org.apache.spark.mllib2.classification._
import org.apache.spark.mllib2.clustering._
import org.apache.spark.mllib2.optimization._
import org.apache.spark.mllib2.linalg._
import org.apache.spark.mllib2.random.{RandomRDDs => RG}
import org.apache.spark.mllib2.recommendation._
import org.apache.spark.mllib2.regression._
import org.apache.spark.mllib2.tree.configuration.{Algo, Strategy}
import org.apache.spark.mllib2.tree.DecisionTree
import org.apache.spark.mllib2.tree.impurity._
import org.apache.spark.mllib2.tree.model.DecisionTreeModel
import org.apache.spark.mllib2.stat.{MultivariateStatisticalSummary, Statistics}
import org.apache.spark.mllib2.stat.correlation.CorrelationNames
...
/**
 * :: DeveloperApi ::
 * The Java stubs necessary for the Python mllib2 bindings.
 */
@DeveloperApi
class PythonMLLibAPI extends Serializable {
  ...
  /**
   * Java stub for Python mllib2 LinearRegressionWithSGD.train()
   */
  ...
  /**
   * Java stub for Python mllib2 LassoWithSGD.train()
   */
  ...
  /**
   * Java stub for Python mllib2 RidgeRegressionWithSGD.train()
   */
  ...
  /**
   * Java stub for Python mllib2 SVMWithSGD.train()
   */
  ...
  /**
   * Java stub for Python mllib2 LogisticRegressionWithSGD.train()
   */
  ...
  /**
   * Java stub for Python mllib2 KMeans.train()
   */
  ...
  /**
   * Java stub for Python mllib2 ALS.train().  This stub returns a handle
  ...
  /**
   * Java stub for Python mllib2 ALS.trainImplicit().  This stub returns a
  ...
  /**
   * Java stub for Python mllib2 DecisionTree.train().
  ...
  /**
   * Java stub for mllib2 Statistics.colStats(X: RDD[Vector]).
  ...
  /**
   * Java stub for mllib2 Statistics.corr(X: RDD[Vector], method: String).
  ...
  /**
   * Java stub for mllib2 Statistics.corr(x: RDD[Double], y: RDD[Double], method: String).
   */
  ...
  /**
   * Java stub for Python mllib2 RandomRDDGenerators.uniformRDD()
   */
  ...
  /**
   * Java stub for Python mllib2 RandomRDDGenerators.normalRDD()
   */
  ...
  /**
   * Java stub for Python mllib2 RandomRDDGenerators.poissonRDD()
   */
  ...
  /**
   * Java stub for Python mllib2 RandomRDDGenerators.uniformVectorRDD()
   */
  ...
  /**
   * Java stub for Python mllib2 RandomRDDGenerators.normalVectorRDD()
   */
  ...
  /**
   * Java stub for Python mllib2 RandomRDDGenerators.poissonVectorRDD()
   */
...
private[spark] object SerDe extends Serializable {
  ...
  val PYSPARK_PACKAGE = "pyspark.mllib2"
