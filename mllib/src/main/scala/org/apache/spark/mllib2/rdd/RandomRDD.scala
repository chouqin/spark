...
package org.apache.spark.mllib2.rdd

import org.apache.spark.{Partition, SparkContext, TaskContext}
import org.apache.spark.mllib2.linalg.{DenseVector, Vector}
import org.apache.spark.mllib2.random.RandomDataGenerator
...
private[mllib2] class RandomRDDPartition[T](override val index: Int,
    val size: Int,
...
private[mllib2] class RandomRDD[T: ClassTag](@transient sc: SparkContext,
    size: Long,
    numPartitions: Int,
...
private[mllib2] class RandomVectorRDD(@transient sc: SparkContext,
    size: Long,
    vectorSize: Int,
    numPartitions: Int,
...
private[mllib2] object RandomRDD {
