...
package org.apache.spark.mllib2.regression
...
import org.apache.spark.mllib2.linalg.{Vectors, Vector}
import org.apache.spark.mllib2.util.MLUtils._
...
abstract class GeneralizedLinearAlgorithm[M <: GeneralizedLinearModel]
   ...
   */
  private[mllib2] def setFeatureScaling(useFeatureScaling: Boolean): this.type = {
