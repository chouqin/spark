...
package org.apache.spark.mllib2.tree
...
import org.apache.spark.mllib2.rdd.RDDFunctions._
import org.apache.spark.mllib2.regression.LabeledPoint
import org.apache.spark.mllib2.tree.configuration.Strategy
import org.apache.spark.mllib2.tree.configuration.Algo._
import org.apache.spark.mllib2.tree.configuration.FeatureType._
import org.apache.spark.mllib2.tree.configuration.QuantileStrategy._
import org.apache.spark.mllib2.tree.impl._
import org.apache.spark.mllib2.tree.impurity.{Impurities, Impurity}
import org.apache.spark.mllib2.tree.impurity._
import org.apache.spark.mllib2.tree.model._
...
class DecisionTree (private val strategy: Strategy) extends Serializable with Logging {
   ...
   * @param input Training data: RDD of [[org.apache.spark.mllib2.regression.LabeledPoint]]
...
object DecisionTree extends Serializable with Logging {
   ...
   *
   * Note: Using [[org.apache.spark.mllib2.tree.DecisionTree$#trainClassifier]]
   *       and [[org.apache.spark.mllib2.tree.DecisionTree$#trainRegressor]]
   *       is recommended to clearly separate classification and regression.
   *
   * @param input Training dataset: RDD of [[org.apache.spark.mllib2.regression.LabeledPoint]].
  ...
  */
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib2.tree.DecisionTree$#trainClassifier]]
   */
  def trainClassifier(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib2.tree.DecisionTree$#trainRegressor]]
   */
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
      categoricalFeaturesInfo: java.util.Map[java.lang.Integer, java.lang.Integer],
   ...
   *
   * @param input Training data: RDD of [[org.apache.spark.mllib2.tree.impl.TreePoint]]
   ...
   *         Splits is an Array of [[org.apache.spark.mllib2.tree.model.Split]]
   *          of size (numFeatures, numSplits).
   *         Bins is an Array of [[org.apache.spark.mllib2.tree.model.Bin]]
