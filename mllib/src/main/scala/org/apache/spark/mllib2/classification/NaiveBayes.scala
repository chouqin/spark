...
import org.apache.spark.mllib2.linalg.{DenseVector, SparseVector, Vector}
 ...
 */
class NaiveBayesModel private[mllib2] (
...
class NaiveBayes private (private var lambda: Double) extends Serializable with Logging {
   ...
   *
   * @param data RDD of [[org.apache.spark.mllib2.regression.LabeledPoint]].
   */
