...
object KMeans {
   ...
   */
  private[mllib2] def findClosest(
   ...
   * [[org.apache.spark.mllib2.util.MLUtils#fastSquaredDistance]].
   */
 ...
 *
 * @see [[org.apache.spark.mllib2.clustering.KMeans#fastSquaredDistance]]
 */
private[clustering]
