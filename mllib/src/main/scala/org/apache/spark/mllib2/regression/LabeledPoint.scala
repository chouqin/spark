...
import org.apache.spark.mllib2.util.NumericParser
...
/**
 * Parser for [[org.apache.spark.mllib2.regression.LabeledPoint]].
 */
object LabeledPoint {
  /**
   * Parses a string resulted from `LabeledPoint#toString` into
   * an [[org.apache.spark.mllib2.regression.LabeledPoint]].
   */
