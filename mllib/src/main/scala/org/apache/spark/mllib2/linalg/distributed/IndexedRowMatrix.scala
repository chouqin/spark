...
package org.apache.spark.mllib2.linalg.distributed
...
import org.apache.spark.mllib2.linalg.SingularValueDecomposition

/**
 * :: Experimental ::
 * Represents a row of [[org.apache.spark.mllib2.linalg.distributed.IndexedRowMatrix]].
 */
@Experimental
...
/**
 * :: Experimental ::
 * Represents a row-oriented [[org.apache.spark.mllib2.linalg.distributed.DistributedMatrix]] with
 * indexed rows.
 *
...
class IndexedRowMatrix(
   ...
   * [[org.apache.spark.mllib2.linalg.distributed.RowMatrix]].
   */
   ...
   *
   * U is an [[org.apache.spark.mllib2.linalg.distributed.IndexedRowMatrix]] of size m x k that
   * satisfies U'U = eye(k),
  ...
  private[mllib2] override def toBreeze(): BDM[Double] = {
    val m = numRows().toInt
    val n = numCols().toInt
