...
import org.apache.spark.mllib2.stat.{MultivariateOnlineSummarizer, MultivariateStatisticalSummary}
...
class RowMatrix(
   ...
   */
  private[mllib2] def multiplyGramianMatrixBy(v: BDV[Double]): BDV[Double] = {
    val n = numCols().toInt
   ...
   * @return a [[org.apache.spark.mllib2.linalg.distributed.RowMatrix]] representing the product,
