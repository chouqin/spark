...
package org.apache.spark.mllib2.util
...
import org.apache.spark.mllib2.linalg.{Vector, Vectors}
...
object MLUtils {
   ...
   * This method parses each line into a [[org.apache.spark.mllib2.regression.LabeledPoint]],
   ...
   *
   * @see [[org.apache.spark.mllib2.util.MLUtils#loadLibSVMFile]]
   */
   ...
   *            [[org.apache.spark.mllib2.util.MLUtils#loadLabeledPoints]] for loading.
   */
   ...
   */
  private[mllib2] def fastSquaredDistance(
      v1: BV[Double],
      norm1: Double,
      v2: BV[Double],
      norm2: Double,
