 ...
 * {{{
 * bin/run-example org.apache.spark.examples.mllibnew.SampledRDDs
 * }}}
 * If you use it as a template to create your own app, please use `spark-submit` to submit your app.
 */
object SampledRDDs {

  case class Params(input: String = "data/mllibnew/sample_binary_classification_data.txt")
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("SampledRDDs") {
      ...
      note(
        ...
        |
        | bin/spark-submit --class org.apache.spark.examples.mllibnew.SampledRDDs \
