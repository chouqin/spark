...
import org.apache.spark.mllibnew.stat.Statistics
 ...
 * {{{
 * bin/run-example org.apache.spark.examples.mllibnew.Correlations
 * }}}
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("Correlations") {
      ...
      note(
        ...
        |
        | bin/spark-submit --class org.apache.spark.examples.mllibnew.Correlations \
