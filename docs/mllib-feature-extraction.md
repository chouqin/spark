...
TF and IDF are implemented in [HashingTF](api/scala/index.html#org.apache.spark.mllibnew.feature.HashingTF)
and [IDF](api/scala/index.html#org.apache.spark.mllibnew.feature.IDF).
...
import org.apache.spark.mllibnew.feature.HashingTF
...
{% highlight scala %}
import org.apache.spark.mllibnew.feature.IDF
...
import org.apache.spark.mllibnew.feature.Word2Vec
...
[`StandardScaler`](api/scala/index.html#org.apache.spark.mllibnew.feature.StandardScaler) has the
...
We provide a [`fit`](api/scala/index.html#org.apache.spark.mllibnew.feature.StandardScaler) method in
...
This model implements [`VectorTransformer`](api/scala/index.html#org.apache.spark.mllibnew.feature.VectorTransformer)
...
{% highlight scala %}
import org.apache.spark.SparkContext._
import org.apache.spark.mllibnew.feature.StandardScaler
...
[`Normalizer`](api/scala/index.html#org.apache.spark.mllibnew.feature.Normalizer) has the following
parameter in the constructor:

* `p` Normalization in $L^p$ space, $p = 2$ by default.

`Normalizer` implements [`VectorTransformer`](api/scala/index.html#org.apache.spark.mllibnew.feature.VectorTransformer)
...
{% highlight scala %}
import org.apache.spark.SparkContext._
import org.apache.spark.mllibnew.feature.Normalizer
import org.apache.spark.mllibnew.linalg.Vectors
import org.apache.spark.mllibnew.util.MLUtils
