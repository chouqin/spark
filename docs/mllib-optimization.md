...
[L1Updater](api/scala/index.html#org.apache.spark.mllibnew.optimization.L1Updater).


### Update schemes for distributed SGD
The SGD implementation in
[GradientDescent](api/scala/index.html#org.apache.spark.mllibnew.optimization.GradientDescent) uses
...
The SGD class
[GradientDescent](api/scala/index.html#org.apache.spark.mllibnew.optimization.GradientDescent)
...
[L1Updater](api/scala/index.html#org.apache.spark.mllibnew.optimization.L1Updater) will not work since the
soft-thresholding logic in L1Updater is designed for gradient descent. See the developer's note.

The L-BFGS method
[LBFGS.runLBFGS](api/scala/index.html#org.apache.spark.mllibnew.optimization.LBFGS)
...
import org.apache.spark.mllibnew.classification.LogisticRegressionModel
...
import org.apache.spark.mllibnew.linalg.Vectors;
import org.apache.spark.mllibnew.optimization.*;
